...
struct ImDrawList {
    ...
    IMGUI_API void AddHalfCircle(const ImVec2 &center, float radius, ImU32 col, int num_segments = 0, float thickness = 1.0f, float arc_degree = 1.f);
    IMGUI_API void AddCircleFilled(const ImVec2 &center, float radius, ImU32 col, int num_segments = 0);
    IMGUI_API void AddNgon(const ImVec2 &center, float radius, ImU32 col, int num_segments, float thickness = 1.0f);
    IMGUI_API void AddNgonFilled(const ImVec2 &center, float radius, ImU32 col, int num_segments);
    IMGUI_API void AddText(const ImVec2 &pos, ImU32 col, const char *text_begin, const char *text_end = NULL);
    IMGUI_API void AddText(const ImFont *font, float font_size, const ImVec2 &pos, ImU32 col, const char *text_begin, const char *text_end = NULL, float wrap_width = 0.0f, const ImVec4 *cpu_fine_clip_rect = NULL);
    IMGUI_API void AddTextRainbow(ImFont *font, ImVec2 Pos, const char *text, float size, float alpha = 1.f);
...
enum ImGuiModFlags_ { ImGuiModFlags_None = 0,
